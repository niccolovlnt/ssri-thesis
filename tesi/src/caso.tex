...
\caption{Frontend di configurazione di una sonda di esempio su MoonCloud.}
...
\caption{Esempio di visualizzazione delle CVE su MoonCloud.}
...
\caption{Dashboard di MoonCloud con i grafici di compliance.}
